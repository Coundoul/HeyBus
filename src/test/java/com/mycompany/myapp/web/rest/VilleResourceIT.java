...
class VilleResourceIT {
    ...
    public static Ville createEntity(EntityManager em) {
        Ville ville = new Ville().nom(DEFAULT_NOM).codePostal(DEFAULT_CODE_POSTAL);
        return ville;
    }
    ...
    public static Ville createUpdatedEntity(EntityManager em) {
        Ville ville = new Ville().nom(UPDATED_NOM).codePostal(UPDATED_CODE_POSTAL);
        return ville;
    }
    ...
    void putNewVille() throws Exception {
        ...
        updatedVille.nom(UPDATED_NOM).codePostal(UPDATED_CODE_POSTAL);
    ...
    void fullUpdateVilleWithPatch() throws Exception {
        ...
        partialUpdatedVille.nom(UPDATED_NOM).codePostal(UPDATED_CODE_POSTAL);
