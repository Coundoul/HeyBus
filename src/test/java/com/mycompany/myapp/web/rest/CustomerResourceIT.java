...
class CustomerResourceIT {
    ...
    private static final LocalDate DEFAULT_DATEPRISECONTACT = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATEPRISECONTACT = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .dateprisecontact(DEFAULT_DATEPRISECONTACT)
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .dateprisecontact(UPDATED_DATEPRISECONTACT)
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getNom()).isEqualTo(DEFAULT_NOM);
        assertThat(testCustomer.getPrenom()).isEqualTo(DEFAULT_PRENOM);
        ...
        assertThat(testCustomer.getDatenaissance()).isEqualTo(DEFAULT_DATENAISSANCE);
        assertThat(testCustomer.getDateprisecontact()).isEqualTo(DEFAULT_DATEPRISECONTACT);
        assertThat(testCustomer.getAdresse()).isEqualTo(DEFAULT_ADRESSE);
    }
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateprisecontact").value(hasItem(DEFAULT_DATEPRISECONTACT.toString())))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.dateprisecontact").value(DEFAULT_DATEPRISECONTACT.toString()))
    ...
    void putNewCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getNom()).isEqualTo(UPDATED_NOM);
        assertThat(testCustomer.getPrenom()).isEqualTo(UPDATED_PRENOM);
        ...
        assertThat(testCustomer.getDatenaissance()).isEqualTo(UPDATED_DATENAISSANCE);
        assertThat(testCustomer.getDateprisecontact()).isEqualTo(UPDATED_DATEPRISECONTACT);
        assertThat(testCustomer.getAdresse()).isEqualTo(UPDATED_ADRESSE);
    }
