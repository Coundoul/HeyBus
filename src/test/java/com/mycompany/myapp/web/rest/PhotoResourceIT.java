...
class PhotoResourceIT {
    ...
    void putNewPhoto() throws Exception {
        ...
        updatedPhoto.title(UPDATED_TITLE).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE).uploaded(UPDATED_UPLOADED);
    ...
    void partialUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.title(UPDATED_TITLE).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
