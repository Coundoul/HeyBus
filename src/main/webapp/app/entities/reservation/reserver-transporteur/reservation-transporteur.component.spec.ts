...
describe('Component Tests', () => {
  describe('Customer Management Update Component', () => {
    let comp: ReservationTransporteurComponent;
    let fixture: ComponentFixture<ReservationTransporteurComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ReservationTransporteurComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(ReservationTransporteurComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ReservationTransporteurComponent);
