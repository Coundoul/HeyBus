...
import { ReservationOrangeComponent } from './reservation-orange.component';

describe('Component Tests', () => {
  describe('Reservation Management Update Component', () => {
    let comp: ReservationOrangeComponent;
    let fixture: ComponentFixture<ReservationOrangeComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ReservationOrangeComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(ReservationOrangeComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ReservationOrangeComponent);
