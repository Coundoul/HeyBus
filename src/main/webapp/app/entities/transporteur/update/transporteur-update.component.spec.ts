  ...
  describe('Transporteur Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call User query and add missing value', () => {
        const transporteur: ITransporteur = { id: 456 };
        const user: IUser = { id: 27699 };
        transporteur.user = user;
        ...
        activatedRoute.data = of({ transporteur });
        comp.ngOnInit();
      ...
      it('Should update editForm', () => {
        ...
        expect(comp.editForm.value).toEqual(expect.objectContaining(transporteur));
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const transporteur = { id: 123 };
        spyOn(transporteurService, 'update').and.returnValue(saveSubject);
        ...
        saveSubject.next(new HttpResponse({ body: transporteur }));
        saveSubject.complete();

        // THEN
        expect(comp.previousState).toHaveBeenCalled();
        expect(transporteurService.update).toHaveBeenCalledWith(transporteur);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        spyOn(transporteurService, 'create').and.returnValue(saveSubject);
        spyOn(comp, 'previousState');
        activatedRoute.data = of({ transporteur });
        comp.ngOnInit();
        ...
        // THEN
        expect(transporteurService.create).toHaveBeenCalledWith(transporteur);
        expect(comp.isSaving).toEqual(false);
        expect(comp.previousState).toHaveBeenCalled();
      });
