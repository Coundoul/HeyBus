...
public class EmployeResource {
    ...
    public ResponseEntity<Employe> createEmploye(@Valid @RequestBody Employe employe) throws URISyntaxException {
        if (SecurityUtils.hasCurrentUserThisAuthority("ROLE_TRANSPORTEUR")) {
            ...
            employe.setTransporteur(employeRepository.findCurrentTransporteur());
        }
        ...
        Optional<Employe> result = employeRepository
            ...
            .map(
                existingEmploye -> {
                    ...
                    if (employe.getMatrimoniale() != null) {
                        existingEmploye.setMatrimoniale(employe.getMatrimoniale());
                    }
                    if (employe.getTelephone() != null) {
                        existingEmploye.setTelephone(employe.getTelephone());
                    }
                    if (employe.getNbreEnfant() != null) {
                        existingEmploye.setNbreEnfant(employe.getNbreEnfant());
                    }
                    if (employe.getPhoto() != null) {
                        existingEmploye.setPhoto(employe.getPhoto());
                    }
                    if (employe.getAccount() != null) {
                        existingEmploye.setAccount(employe.getAccount());
                    }
