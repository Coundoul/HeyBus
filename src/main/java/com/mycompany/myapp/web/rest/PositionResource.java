...
public class PositionResource {
    ...
    public ResponseEntity<Position> partialUpdatePosition(
        ...
        Optional<Position> result = positionRepository
            ...
            .map(
                existingPosition -> {
                    if (position.getNom() != null) {
                        existingPosition.setNom(position.getNom());
                    }
                    if (position.getDescription() != null) {
                        existingPosition.setDescription(position.getDescription());
                    }
                    if (position.getReference() != null) {
                        existingPosition.setReference(position.getReference());
                    }
                    if (position.getNiveau() != null) {
                        existingPosition.setNiveau(position.getNiveau());
                    }
