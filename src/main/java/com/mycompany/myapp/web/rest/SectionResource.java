...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Section}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingSection -> {
                    ...
                    if (section.getReference() != null) {
                        existingSection.setReference(section.getReference());
                    }
                    if (section.getNiveau() != null) {
                        existingSection.setNiveau(section.getNiveau());
                    }
