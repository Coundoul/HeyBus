...
public class PhotoResource {
    ...
    public ResponseEntity<Photo> createPhoto(@Valid @RequestBody Photo photo) throws URISyntaxException {
        ...
        if (SecurityUtils.hasCurrentUserThisAuthority("ROLE_TRANSPORTEUR")) {
            ...
            photo.setTransporteur(photoRepository.findCurrentTransporteur());
        }
    ...
    public List<Photo> getAllPhotos() {
        ...
        if (SecurityUtils.hasCurrentUserThisAuthority("ROLE_ADMIN")) return photoRepository.findAll();

        return photoRepository.findByUserIsCurrentUser();
    }
