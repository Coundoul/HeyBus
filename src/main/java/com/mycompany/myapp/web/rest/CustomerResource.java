            ...
            .map(
                existingCustomer -> {
                    ...
                    if (customer.getPrenom() != null) {
                        existingCustomer.setPrenom(customer.getPrenom());
                    }
                    ...
                    if (customer.getDatenaissance() != null) {
                        existingCustomer.setDatenaissance(customer.getDatenaissance());
                    }
                    if (customer.getDateprisecontact() != null) {
                        existingCustomer.setDateprisecontact(customer.getDateprisecontact());
                    }
