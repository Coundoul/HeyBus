...
public class MaintenanceResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/maintenances/{id}", consumes = "application/merge-patch+json")
        ...
        Optional<Maintenance> result = maintenanceRepository
            ...
            .map(
                existingMaintenance -> {
                    ...
                    if (maintenance.getNbreKmMoteur() != null) {
                        existingMaintenance.setNbreKmMoteur(maintenance.getNbreKmMoteur());
                    }
    ...
    public List<Maintenance> getAllMaintenances() {
        ...
        if (SecurityUtils.hasCurrentUserThisAuthority("ROLE_ADMIN")) return maintenanceRepository.findAll();

        return maintenanceRepository.findByUserIsCurrentUser();
    }
